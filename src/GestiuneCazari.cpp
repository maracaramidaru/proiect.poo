...
void GestiuneCazari::adaugaCazare(const std::string& destinatie, std::shared_ptr<Cazare> cazare) {
...
void GestiuneCazari::afiseazaCazariPentruDestinatie(const std::string& destinatie) const {
    auto it = cazariPerDestinatie.find(destinatie);
    if (it == cazariPerDestinatie.end()) {
